...
ggsave("vaxmapnolabels.png", vax_map, height = 7, width = 7)
...
ggsave("groupingmapnolabels.png", grouping_map, height = 7, width = 7)
...
mortalitymap <- ggplot() + 
   geom_sf(data = tomapmortality, aes(geometry = geometry, fill = cumulative_deaths)) +
    ...
    scale_color_manual(values = mapcolorscustom) +
    labs(fill = "Deaths", title = "Deaths During Spring Wave") +
    theme(legend.position = "right", 
        plot.title = element_text(hjust = 0.5),
        legend.title = element_text(size = 12, face = "bold"),
        legend.text = element_text(size = 12),
...
ggsave("springwavemortalitymapnolabels.png", mortalitymap, height = 7, width = 7)
...
mortalitycumulativedid <- mortalitycumulative +
  ...
  geom_line(data = filter(to_did, vax_group == n_labels[1]), 
            ...
            linetype = "dashed") +
  scale_fill_manual(values = c(graphcolors[3], graphcolors[1], "#FFFFFF")) +
  scale_color_manual(values = c(graphcolors[3], graphcolors[1], "#FF0000")) +
  scale_shape_manual(values = c(graphshapes[3], graphshapes[1], 1)) +
...
linearHypothesis(paralleltrendtest, c("week:vax_group[17.8,28.3] = 0", "week:vax_group(28.3,38.8]"))
